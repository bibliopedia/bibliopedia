// DotNetWikiBot Framework 2.81 - bot framework based on Microsoft .NET Framework 2.0 for wiki projects
...
namespace DotNetWikiBot
{
	...
	public class PageList
	{
		...
		public void LoadEx()
		{
			...
			foreach (Page page in pages)
				postData += HttpUtility.HtmlEncode(page.title) + "\r\n";
	...
	public class Bot
	{
		...
		public static readonly Version version = new Version("2.81");
