...
{
    public class CalaisTextProcessor : CalaisProcessor
    {
            ...
            return
                string.Format(
                    @"<c:params xmlns:c={0}http://s.opencalais.com/1/pred/{0} xmlns:rdf={0}http://www.w3.org/1999/02/22-rdf-syntax-ns#{0}>
                        <c:processingDirectives c:contentType={0}text/raw{0} c:enableMetadataType={0}GenericRelations{0} c:outputFormat={0}Text/Simple{0} c:docRDFaccesible={0}true{0} >
