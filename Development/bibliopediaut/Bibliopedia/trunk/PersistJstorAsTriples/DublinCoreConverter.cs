...
namespace PersistJstorAsTriples
{
    public class DublinCoreConverter
    {
        ...
        {
            var output = new Document_(MakeUri(input.Sha1Hash), RdfDocument);
            ...
            output.AddComment(new RdfLiteralString(input.Value));
        ...
        private RdfResource[] CreateResources(IEnumerable<HashedValue> items, RdfDocument RdfDocument)
        {
