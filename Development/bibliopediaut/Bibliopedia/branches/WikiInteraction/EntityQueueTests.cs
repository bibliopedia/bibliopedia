...
//        public virtual QueueType GetQueue<QueueType>() where QueueType : EntityQueue<JstorDoi> { return EntityQueue<JstorDoi>.Get<QueueType>(Session); }
...
//        {
//            using (var q = EntityQueue<JstorDoi>.Create<CitationQueue>())
//            {
//                Assert.NotNull(q);
//            }
//        }
...
//        {
//            using (var queue = GetQueue<TestQueue>())
//            {
