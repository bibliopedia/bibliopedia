...
namespace Data.FluentsNeeds
{
    public class AutoDetectStrategies : IAutoMappingAlteration
    {
        ...
        {
            Iesi.Collections.Generic.ISet<Type> types = new HashedSet<Type>();
        ...
        private IEnumerable<Type> Strategies()
        {
            foreach (Type type in Assembly.GetTypes())
            {
                ...
                if (!Conventions.DomainTypeFilter(type)) continue;
                if (type.IsSubclassOf(Conventions.AutoDetectStrategyBaseType())) continue;
                ...
                if (type.
                        ...
                        Where(t =>
                              ...
                              DomainFilter(typeClosure)).FirstOrDefault() == null) continue;
